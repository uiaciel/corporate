    ...
    <div class="container-fluid p-0">
        <div class="row mb-2 mb-xl-3">
            <div class="col-auto d-none d-sm-block">
                <h3><strong>REPORTS</strong></strong> <a href="{{ route('reports.create') }}"
                                            ...
                                            <td>
                                                <form onsubmit="return confirm('{{ __('admincp.areyousure') }}');"
                                                    ...
                                                    <a href="" data-bs-toggle="modal"
                                                        ...
                                                        class="btn btn-md btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        class="btn btn-md btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                                </form>
                                            </td>
                                            <!-- Modal -->
                                                        ...
                                                        <form action="{{ route('reports.update', $annual->id) }}"
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-4">
                                                                        <div class="mb-3">
                                                                            <img id="imgPreview" src="/storage/{{ $annual->image }}" alt="preview image"
                                                                                class="img-fluid">
                                                                    ...
                                                                    <div class="col-8">
                                                                        <div class="mb-3">
                                                                            <div class="input-group">
                                                                                <span class="input-group-text"
                                                                                    id="basic-addon1"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <div class="input-group">
                                                                                <span class="input-group-text"
                                                                                    id="basic-addon1"><i class="fa fa-list" aria-hidden="true"></i></span>
                                                                                <select
                                                                                    class="form-select  @error('id_category') is-invalid @enderror"
                                                                                    name="category">
                                                                                    <option
                                                                                        value="{{ $annual->category }}">
                                                                                        {{ $annual->category }}
                                                                                    </option>
                                                                                    ...
                                                                                    <option value="Financial Report">
                                                                                        ...
                                                                                        Report</option>
                                                                                    <option
                                                                                        value="Public Offering Prospectus">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <div class="input-group">
                                                                                <span class="input-group-text"
                                                                                    id="basic-addon1"><i class="fa fa-eye" aria-hidden="true"></i></span>
                                                                                <select
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <div class="input-group">
                                                                                <span class="input-group-text"
                                                                                    id="basic-addon1"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                                                                <input type="date"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form onsubmit="return confirm('{{ __('admincp.areyousure') }}');"
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="btn btn-md btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></i></button>
                                            </form>
                                        </td>
                                        <!-- Modal -->
                                                    ...
                                                    <form action="{{ route('reports.update', $financial->id) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <div class="mb-3">
                                                                        <img id="imgPreview" src="/storage/{{ $financial->image }}" alt="preview image"
                                                                            class="img-fluid">
                                    ...
                                    <div class="modal fade" id="edit{{ $offering->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-md">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('reports.update', $offering->id) }}"
                                                    method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
